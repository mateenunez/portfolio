...
export function AutoCarousel() {
    ...
    const handleScroll = () => {
      ...
      if (mainContainer) {
        ...
        const scrollProgress =
          1 - mainContainerRect.bottom / window.innerHeight;
  ...
  return (
    <div
      ...
      style={{ opacity }}
    >
      <Card className="w-full h-full bg-[#000000] backdrop-blur-sm p-8 overflow-hidden">
            ...
            <div key={rowIndex} className="overflow-hidden" ref={ref}>
              <div className="flex gap-4 animate-slide-row">
                {images.map((image, index) => (
                  <a
                    key={index}
                    className="flex-shrink-0 w-[20rem] aspect-video bg-white rounded-lg shadow-md overflow-hidden"
                    href={image.href}
                  >
                    <Image
        ...
        <Button
          ...
          className="absolute bottom-4 right-4 bg-blue-500 text-white"
        >
